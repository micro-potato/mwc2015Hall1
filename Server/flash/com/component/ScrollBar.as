...
package com.component
{
	...
	public class ScrollBar
	{
		...
		*/  
		...
		public function SetY(offset:Number)
		{
			_scrollBar[_coor] += offset;
			judgeBoundary();
		}
		...
		private function scrollBarLength():void
		{
			...
			if (_direction == "L")
			{
				var maxLenght:Number = this._maskTarget.height;
				var percent:Number = this._maskTarget.height / _target.height;
				//trace("percent:" + percent);
				this._scrollBar.height = maxLenght * percent;
			}
		}
		...
		private function scrollMachine():void
		{
			...
			_targetPoint = _maskTarget[_coor] - (_scrollBar[_coor] - _scrollBarOriginalPoint[_coor]) * (_target[_length] - _maskTarget[_length]) / (_scrollLine[_length] - _scrollBar[_length])-10;
